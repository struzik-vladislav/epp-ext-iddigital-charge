...
class ChargeInfoData
{
    ...
    {
        $node = $this->response->getFirst('//epp:epp/epp:response/epp:extension/charge:infData/charge:set/charge:category');
    ...
    {
        $node = $this->response->getFirst('//epp:epp/epp:response/epp:extension/charge:infData/charge:set/charge:type');
    ...
    {
        $xpathQuery = sprintf(
            '//epp:epp/epp:response/epp:extension/charge:infData/charge:set/charge:amount[@command=\'%s\']',
    ...
    {
        $xpathQuery = sprintf(
            '//epp:epp/epp:response/epp:extension/charge:infData/charge:set/charge:amount[@command=\'%s\' and @name=\'%s\']',
