...
class ChargeUpdateData
{
    ...
    {
        $node = $this->response->getFirst('//epp:epp/epp:response/epp:extension/charge:upData/charge:set/charge:category');
    ...
    {
        $node = $this->response->getFirst('//epp:epp/epp:response/epp:extension/charge:upData/charge:set/charge:type');
    ...
    {
        $xpathQuery = sprintf(
            '//epp:epp/epp:response/epp:extension/charge:upData/charge:set/charge:amount[@command=\'%s\']',
    ...
    {
        $xpathQuery = sprintf(
            '//epp:epp/epp:response/epp:extension/charge:upData/charge:set/charge:amount[@command=\'%s\' and @name=\'%s\']',
